...
class wsdl extends nusoap_base {
     ...
     * @access public 
     */
    function __construct($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=180){
        $this->wsdl = $wsdl;
...
class soapclientx extends nusoap_base  {
	...
	* @access   public
	*/
	function __construct($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 180){
