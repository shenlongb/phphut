...
if ($step == 0) {
    ...
    $step_caption[0] = array("bgcolor" => "#dddddd", "fontcolor" => "#999999", "tag" => "->");
...
";
    ...
    $step_caption[1] = array("bgcolor" => "#dddddd", "fontcolor" => "#999999", "tag" => "->");

    //php版本检测
    $php_version = substr(PHP_VERSION,0,3);
    if ($php_version < 4.2 || $php_version > 7.0){
    ...
    $step_content .= "<tr><td style=\"font-size: 16px; color: #003399; font-weight:bold;\">PHPWEB安装向导 - 第 <strong>2</strong> 步：检测服务器环境<br><hr size=\"1\" width=\"98%\" align=\"left\">" . $error_msg . "</td></tr>";
    ...
    $step_caption[2] = array("bgcolor" => "#dddddd", "fontcolor" => "#999999", "tag" => "->");
    ...
    $step_content .= "<table width=\"100%\"  border=\"0\" cellspacing=\"0\" cellpadding=\"3\">";
    $step_content .= "<tr><td colspan=\"2\" style=\"font-size: 16px; color: #003399; font-weight:bold;\">PHPWEB安装向导 - 第 <strong>3</strong> 步：设置数据库参数<br><hr size=\"1\" width=\"98%\" align=\"left\">" . $error_msg . "</td></tr>";
    ...
    $step_caption[3] = array("bgcolor" => "#dddddd", "fontcolor" => "#999999", "tag" => "->");

} else if ($step == 4) {
    $step_caption[4] = array("bgcolor" => "#dddddd", "fontcolor" => "#999999", "tag" => "->");
    ...
    $step_caption[5] = array("bgcolor" => "#dddddd", "fontcolor" => "#999999", "tag" => "->");
    ...
    <tr>
      <td width="229" valign="top" align="center"> 
        <table width="100%"  border="0" cellpadding="5" cellspacing="0">
          ...
          <tr>
            <td align="right" bgcolor="<?php echo $step_caption[1]["bgcolor"]?>" class="font_13_w" style="border-top: 1 solid #ffffff; border-right: 3 solid #ffcc00; color: <?php echo $step_caption[1]["fontcolor"]?>"><?php echo $step_caption[1]["tag"];?>&nbsp;检测服务器环境</td>
          </tr>
          <tr> 
            <td align="right" bgcolor="<?php echo $step_caption[2]["bgcolor"]?>" class="font_13_w" style="border-top: 1 solid #ffffff; border-right: 3 solid #ffcc00; color: <?php echo $step_caption[2]["fontcolor"]?>"><?php echo $step_caption[2]["tag"];?>&nbsp;设置数据库参数</td>
          </tr>
          <tr> 
            <td align="right" bgcolor="<?php echo $step_caption[3]["bgcolor"]?>" class="font_13_w" style="border-top: 1 solid #ffffff; border-bottom: 1 solid #ffffff; border-right: 3 solid #ffcc00; color: <?php echo $step_caption[3]["fontcolor"]?>"><?php echo $step_caption[3]["tag"];?>&nbsp;导入系统初始数据</td>
          </tr>
          <tr> 
            <td align="right" bgcolor="<?php echo $step_caption[4]["bgcolor"]?>" class="font_13_w" style="border-right: 3 solid #ffcc00; color: <?php echo $step_caption[4]["fontcolor"]?>"><?php echo $step_caption[4]["tag"];?>&nbsp;设置网站管理员密码</td>
          </tr>
          <tr> 
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            <td align="center"><p style="FONT:bold 12px/20px Verdana, Arial, Helvetica, sans-serif;color:#fff;">Powered By <a href="javascript:;" style="color:#fff;">phpweb</a></td>
          </tr>
        </table>
      </td>
