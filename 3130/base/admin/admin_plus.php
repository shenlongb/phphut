...
echo "<s";
echo "cript type=\"text/javascript\" src=\"js/api.js\"></script>\r\n\r\n</head>\r\n<body>\r\n\r\n<div class=\"formzone\">\r\n<div class=\"rightzone\">\r\n<div id=\"notice\" style=\"display:none\"></div>\r\n<form action=\"\" method=\"post\" enctype=\"multipart/form-data\" name=\"plusInput\" id=\"plusnewInput\" >\r\n  <input type=\"file\" name=\"datafile\" id=\"datafile\" size=\"35\" class=\"input\" />\r\n  <input type=\"submit\" id=\"addplus\" name=\"addplus\" value=\"";
echo $strPlusInput;
...
while ( $msql->next_record( ) )
{
    ...
    $tempnum = $tempnum + 1;
    $usenums = 0;
    $fsql->query( "select count(id) from {P}_base_plus where pluslable='{$pluslable}'" );
    if ( $fsql->next_record( ) )
    {
        $usenums = $fsql->f( "count(id)" );
    }
    echo " \r\n          <tr class=\"list\"> \r\n            <td height=\"22\"> ";
    echo $plusname;
    echo "<br />\r\n            ";
